{
  ...
  "package": {
    ...
    "version": "0.0.1",
    "description": "Controlador para el transmisor serie. Implementado en un único bloque verilog",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "f5ff864c-abd5-45df-b03c-6843a45761d5",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "44c05dfd-751e-4f72-aa92-5b91aba98a88",
          "type": "basic.info",
          "data": {
            "info": "Máquina de estados (autómata finito)\nImplementado con un único bloque Verilog",
            "readonly": true
          },
          "position": {
            "x": 232,
        ...
        {
          "id": "ec7250f3-7371-4d7a-a3a5-2d6cd15dbbdb",
          "type": "basic.info",
          "data": {
