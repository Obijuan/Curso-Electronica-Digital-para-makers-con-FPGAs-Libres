{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "dd04a559-b1fc-4dd1-9082-e16e10f2d08b",
          "type": "basic.output",
          "data": {
            "name": "D0",
            "pins": [
        ...
        {
          "id": "c941ce20-3875-4bf9-bdf4-498b8d7bde5c",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "dd71eff7-8334-4b83-9cdf-d2b656eb5649",
          "type": "basic.output",
          "data": {
            "name": "D0",
            "pins": [
        ...
        {
          "id": "530b780d-915f-487a-879c-65ce06487aa8",
        ...
        {
          "id": "7b4ac422-df2f-4971-b427-77bf060ff813",
          "type": "52574d9d0e8b304c5dc0732a496a9d43a62b94b1",
          "position": {
            "x": 400,
            "y": 312
        ...
        {
          "id": "073b4df4-20cb-4b49-bbdb-b587a494e78b",
        ...
        {
          "id": "f5dbd3bc-bf7d-48b6-b496-f1eac5063040",
      ...
      "wires": [
        {
          "source": {
            "block": "530b780d-915f-487a-879c-65ce06487aa8",
            "port": "910bbdc3-5979-4834-ab08-a96083e784ce"
          },
          "target": {
            "block": "dd04a559-b1fc-4dd1-9082-e16e10f2d08b",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "c941ce20-3875-4bf9-bdf4-498b8d7bde5c",
            "port": "out"
          },
          "target": {
            "block": "530b780d-915f-487a-879c-65ce06487aa8",
        ...
        },
        {
          ...
          "target": {
            "block": "7b4ac422-df2f-4971-b427-77bf060ff813",
            "port": "e3e07bdb-9bb3-4afb-ace5-bcc99aecef0a"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "dd71eff7-8334-4b83-9cdf-d2b656eb5649",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "073b4df4-20cb-4b49-bbdb-b587a494e78b",
        ...
        {
          "source": {
            "block": "f5dbd3bc-bf7d-48b6-b496-f1eac5063040",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "7b4ac422-df2f-4971-b427-77bf060ff813",
