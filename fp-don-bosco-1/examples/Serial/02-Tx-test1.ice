{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "bc926c96-4a72-4e89-9f26-eeb610f1e11b",
          "type": "basic.output",
          "data": {
            "name": "DEBUG_RDY",
            "pins": [
        ...
        {
          "id": "cd2cec2d-c3cd-4a44-b9cf-1786ad367908",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "07cf0950-510a-4560-b04c-2a61b6402ff2",
          "type": "basic.output",
          "data": {
            "name": "DEBUG",
            "pins": [
        ...
        {
          "id": "f7449a34-ebf9-4992-9f97-9301d2aac77b",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "8'h41",
        ...
        {
          "id": "839ad92e-7f6d-4bed-948f-e680b9b3c7ae",
        ...
        {
          "id": "38abf600-7285-405b-8977-ce23476fdf6a",
        ...
        {
          "id": "18781bb4-1806-4af3-9dfb-ef6237280287",
          "type": "basic.info",
          "data": {
            "info": "Ejemplo del transmisor serie\nCada vez que se aprieta el pulsador SW1, \nse envía un byte por el puerto serie",
            "readonly": true
          },
          "position": {
            "x": -112,
        ...
        {
          "id": "b68d9e94-2989-4ce8-bc90-eb93c9fbcf3c",
          "type": "basic.info",
          "data": {
            "info": "Valor a enviar. Se escribe en notación Verilog.\nEjemplos:\n * 8'b11111111  : Enviar 8 bits a 1 (0xFF)\n * 8'hFF        : Lo mismo, en hexadecimal\n * 8'hAA        : Enviar el valor 10101010\n * 8'h41        : Enviar una 'A'",
            "readonly": true
          },
          "position": {
            "x": -144,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "f7449a34-ebf9-4992-9f97-9301d2aac77b",
            "port": "constant-out"
          },
          "target": {
            "block": "839ad92e-7f6d-4bed-948f-e680b9b3c7ae",
            "port": "c0fb4784-5e8c-4f41-9f4b-6daa2e9e03a4"
          }
        },
        {
          "source": {
            "block": "38abf600-7285-405b-8977-ce23476fdf6a",
        ...
        },
        {
          ...
          "target": {
            "block": "cd2cec2d-c3cd-4a44-b9cf-1786ad367908",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "bc926c96-4a72-4e89-9f26-eeb610f1e11b",
            "port": "in"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "07cf0950-510a-4560-b04c-2a61b6402ff2",
            "port": "in"
          }
        }
      ]
