{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "81f8b65f-62f1-4c35-93c0-ad82f4472691",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "42ac2818-22b7-4d0e-9fd6-4c2ea47ec0ae",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "8221b8a4-cce5-4238-860b-440c92f8b94f",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "a179201f-2efb-4781-9302-af0d9acf5a0d",
        ...
        {
          "id": "1a16e637-44fb-4bbe-b867-611e212b88f0",
        ...
        {
          "id": "aabb5c41-62dd-4b2e-a25d-a4c2ae121dbe",
          "type": "bb09f06ec032be6ab247e81153472e4c56a03be2",
          "position": {
            "x": 136,
            "y": -208
        ...
        {
          "id": "712499d3-4b67-4401-8657-d654e58a1dcd",
          "type": "153df11a89a2ff5f90f196621a11a54b7b8175f4",
          "position": {
            "x": 136,
            "y": -296
        ...
        {
          "id": "2fb876f8-9a21-450e-b34e-a0f3a4a42baf",
          "type": "basic.info",
          "data": {
            "info": "Antorcha Encendida: 1",
            "readonly": false
          },
          "position": {
            "x": 456,
        ...
        {
          "id": "b2e07967-7a07-43b6-9ad9-0746b823131b",
          "type": "basic.info",
          "data": {
            "info": "Antorcha Apagada: 0",
            "readonly": false
          },
          "position": {
            "x": 456,
      ...
      "wires": [
        {
          "source": {
            "block": "a179201f-2efb-4781-9302-af0d9acf5a0d",
        ...
        {
          "source": {
            "block": "1a16e637-44fb-4bbe-b867-611e212b88f0",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "8221b8a4-cce5-4238-860b-440c92f8b94f",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "aabb5c41-62dd-4b2e-a25d-a4c2ae121dbe",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "42ac2818-22b7-4d0e-9fd6-4c2ea47ec0ae",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "712499d3-4b67-4401-8657-d654e58a1dcd",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "81f8b65f-62f1-4c35-93c0-ad82f4472691",
            "port": "in"
          },
          "vertices": []
        }
