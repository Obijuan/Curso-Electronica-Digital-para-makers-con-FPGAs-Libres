  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "6bb85dc7-2f18-4a80-b5fe-2ba96dc46526",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo de prueba del regigistro de desplazamiento\nde 10 bits, con valor inicial 1111111111\n\nModo desplazamiento (load = 0). Por la entrada serie\nse introduce un 0. Cada vez que se aprieta pulsador\nse envia bit de salida. Al cabo de 10 pulsaciones\nel led se apagará\n",
            "readonly": false
          },
          "position": {
            "x": 336,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "6bb85dc7-2f18-4a80-b5fe-2ba96dc46526",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "66826385-f80b-4b90-862f-7180204b034c",
